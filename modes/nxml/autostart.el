...
;; Version:
;; Last-Updated: Wed Feb 21 01:01:14 2007 (3600 +0100)
;; Keywords:
;; Compatibility:
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(message "Autostart.el here")
(unless (featurep 'nxml-nxhtml-autostart)
  (provide 'nxml-nxhtml-autostart)
  (let* ((thisdir (file-name-directory
                   (if load-file-name load-file-name buffer-file-name))))
    (load (expand-file-name "nxml-mode-20041004/rng-auto.el" thisdir))
    (load (expand-file-name "nxhtml/nxhtml-autoload" thisdir))
