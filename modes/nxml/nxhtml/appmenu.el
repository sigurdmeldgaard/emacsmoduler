...
(defconst appmenu:version "0.51") ;; Version:
;; Last-Updated: Tue Feb 20 23:59:36 2007 (3600 +0100)
;; Keywords:
;; Compatibility:
;;
...
(defcustom appmenu-items-visible t
  "Non-nil means show AppMenu help on AppMenu popup."
  :type 'boolean
  :group 'appmenu)

(defcustom appmenu-major-mode t
  "Non-nil means show major mode on AppMenu popup."
  :type 'boolean
  :group 'appmenu)

(defcustom appmenu-minor-modes t
