...
;; Compatibility: Emacs23, Emacs22, Emacs21
;; Incompatibility: Emacs19, Emacs20
;; Last Updated: Sun 2009-02-15 03:05:36 +0000
...
(defun hfy-invisible (&optional val)
  "This text should be invisible. Do something in CSS to make that happen."
  '(("display" . "none")))
...
(defun hfy-prop-invisible-p (prop)
  ;;(message "(hfy-prop-invisible-p %s) [%S]" prop buffer-invisibility-spec)
...
characters such as ^L (\x0c) or Â¤ (\xa4) won't get mapped yet.
