  ...
  (let ((color-theme-is-cumulative t))
    ...
    (color-theme-install
     '(color-theme-gnome2
       ...
       (bold ((t (:bold t))))
       (bold-italic ((t (:italic nil :bold t :foreground "beige")))) ; ...
       ...
       (flymake-warnline ((t (:foreground "black"))))
       (flymake-errline ((t (:foreground "black"))))
       (nxml-comment-content-face ((t (:slant normal :foreground "LightBlue" :bold t))))
